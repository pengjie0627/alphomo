export default class EnvUtil {
  static getServiceUrl () {
    if (EnvUtil.isDev() || EnvUtil.isTest()) {
      ...
      return 'https://api-alphamo-branch-jd.qianfan123.com:8301/alphamo'
  ...
  static getVipmroServiceUrl () {
    if (EnvUtil.isDev() || EnvUtil.isTest()) {
      return 'https://passport.test.vipmro.com'
    } else if (EnvUtil.isJdBranch()) {
      return 'https://passport.test.vipmro.com'
    } else if (EnvUtil.isBranch()) {
      return 'https://passport.test.vipmro.com'
      ...
      return 'https://passport.vipmro.com'
    }
  }
