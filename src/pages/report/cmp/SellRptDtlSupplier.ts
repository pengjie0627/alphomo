  ...
  getSummaries(param: any) {
    ...
    if (this.summary !== null) {
      ...
      if (this.merchantConfig.enableInputTaxRateSupport && !this.merchantConfig.inputReportOnlyTax) {
        sums[3] = this.summary ? this.fmtThumb(this.summary.taxExcAmount.toString()) : 0.00
        sums[4] = this.summary ? this.fmtThumb(this.summary.amount.toString()) : 0.00
      } else {
        sums[3] = this.summary ? this.fmtThumb(this.summary.amount.toString()) : 0.00
      }
    }
    return sums
  }
