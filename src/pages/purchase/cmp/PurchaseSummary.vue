<template>
  <div class="purchase-summary">
    ...
    <qf-form-item v-if="false" label="优惠金额" labelWidth="100px" class="form-item">
      <qf-input v-model="bill.discountAmount" selectOnfocus scale="2" align="right" v-form:discountAmount="validator">
        <span slot="icon">-</span>
      </qf-input>
    </qf-form-item>
    <qf-form-item v-if="false" label="应付总额" labelWidth="100px" class="form-item label-bold">
      <qf-input :value="realAmount()" scale="2" align="right" class="readOnly-input red-amount"></qf-input>
    </qf-form-item>
  </div>
</template>

<script lang="ts" src="./PurchaseSummary.ts"></script>
