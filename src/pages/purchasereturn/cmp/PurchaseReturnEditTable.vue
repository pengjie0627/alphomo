<template>
  <div class="grid">
    <qf-table :data="lines" @selection-change="selectionChange" ref="skuTable" row-key="id"
      ...
      <qf-table-column label="可退数量" prop="canReturnQty" v-if="isReturnFromPurchase" align="right"></qf-table-column>
      ...
      <qf-table-column min-width="110px;" label="税率" prop="taxRate" align="right" v-if="merchantConfig.enableInputTaxRateSupport">
        <template slot-scope="props">
      ...
      <qf-table-column label="税额" prop="taxAmount" scale="2" :formatter="taxAmountFormat" align="right" width="110px"
                       v-if="merchantConfig.enableInputTaxRateSupport"/>
    </qf-table>
  </div>
</template>

<script lang="ts" src="./PurchaseReturnEditTable.ts"></script>
