  ...
  <div class="sale-return-title">
    <div class="bill-info">
      ...
      <div class="bill-num">
        ...
        <div v-if="bill.sale">
          <label>销售单号: </label>
          <a @click="toSaleDtl()" class="pre-bill">
            <label>{{bill.saleBillNum}}</label>
          </a>
        </div>
      </div>
    </div>
    <label class="billType">
      <span class="type-title">销售退货单</span>
...
<script lang="ts" src="./SaleReturnTitle.ts"></script>
