<template>
  <query-condition ref="query" @search="doSearch" @reset="doReset" @toggle="doToggle" class="sale-return-list-search">
        ...
        <qf-col :span="8">
          <qf-form-item label="状态">
            <qf-select v-model="queryCondition.status" clearable>
              ...
              <qf-option value="PART_RECEIVED" label="部分入库"></qf-option>
              <qf-option value="RECEIVED" label="已入库"></qf-option>
...
<script lang="ts" src="./SaleReturnListSearch.ts"></script>

<style lang="scss">
  .sale-return-list-search {
